...
| [0041](0041-a-tenant-is-a-workspace-and-a-client-is-a-party-in-the-operator-tenant.md) | A tenant is a workspace and a client is a party in the operator tenant: Yosher runs on its own platform, the console provisions and links out, prospects live in the CRM, nothing is named Yosher | 2026-09-09 | Proposed |
