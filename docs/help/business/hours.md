...
> Your monthly retainer with Yosher: how much of it you have used, how to buy more, and the log of the work done for you.
...
- **If your business is the one that runs Yosher** — the operator workspace — the page is one card, `No retainer`, with the line `This is the operator tenant. It cannot hold a retainer with itself.` and no meter, no blocks and no log. No client ever sees this card.
