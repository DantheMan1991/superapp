...
- **The row under the title.** Three tabs: `Brand`, `Website`, and `Social`. This page sits under `Social`; {button:Accounts|outline} on that page opens it, and `Back to social` goes back.
...
Writing and scheduling posts: [Your social posts](social.md). The marks at the bottom of your website, which you can also add and remove by hand: `The header and the footer` on [Your website](website.md). Your logo, colors and name: [Your brand kit](overview.md). Writing a post, planning what to post, and posting it for you are not built yet.
