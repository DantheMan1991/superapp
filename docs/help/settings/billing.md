...
- **If your business is the one that runs Yosher** — the operator workspace — the page is one card, `Not billed`, with the line `This is the operator tenant. It is not billed by itself.` and no plans and no portal. No client ever sees this card.
