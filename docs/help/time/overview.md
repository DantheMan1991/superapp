...
> Keep a record of who worked, how long, and on which day, by running a clock or by writing hours down, and see the overtime in it. Three screens: the week, where time is recorded; the pay period, where it is added up the way you pay it; and People, where you say whose hours you keep and set the rules.
> **Route:** /dashboard/m/time/**
> **Order:** 100

Open **Time** {icon:clock} in the sidebar. You land on the current week, with everybody's hours grouped by day. Before you can log anything, somebody has to be on the People list, so a brand new workspace starts there.

Time records what was worked. [Work](../work/overview.md) records what still has to be done. They are different lists on purpose, and nothing you log here ticks anything off there.
...
Time works out what people have **earned**, and stops there. What is withheld, what is filed and what reaches somebody's bank account is your payroll provider's job, and always will be — Time gives you a file to hand them.

Contractors are paid here the same way as employees: their hours become wages, not a bill to a vendor. And wages go to one set of books, the company you have marked as your default in Accounting. Ask us if either matters to you.

The shared clock needs a signal. It will not record a punch it could not send — it says so rather than pretending — and working with no connection at all is still to come.
...
Owners can do everything, including setting pay rates, approving hours, locking a period and deciding whether wages reach your books. Staff can start and stop clocks, log, change and delete hours, and send hours for approval — but never see what anybody is paid. Accountants can read every hour, and also never see pay.
