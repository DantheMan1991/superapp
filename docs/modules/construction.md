...
| 13 | ~~`warranty`~~ **SHIPPED 2026-09-16** ([jobs.md](jobs.md), [ADR 0076](../decisions/0076-a-warranty-claim-is-the-record-of-a-call-its-work-is-a-work-item-the-period-is-the-jobs-and-a-claim-outside-it-is-said-never-refused.md)) · `bonding`, `certified-payroll` | The period on the job — months from substantial completion, the expiry derived — and a claim as the record of the call: what, where, who, when, the trade responsible, the decision with its reason; the work an ordinary Work item linked to the claim, so the digest chases it; where it stands derived; the cost read from the job cost report under the claim's code; a claim outside the period said, never refused. A Warranty tab per job and a page across jobs. **`bonding` and `certified-payroll` remain: last, and certified payroll may not belong in software at all.** |
