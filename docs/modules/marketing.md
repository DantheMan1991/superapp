...
0315 and 0316** (`social_posts` + its policies), applied to dev AND prod before
the merge; `verify-rls` reads 187 tables on both.

**Generated as `0309`/`0310` and renumbered FOUR TIMES** (→ 0311/0312 →
0313/0314 → 0315/0316) — Time slices 3, 4 and 5 each took the next pair of slots
