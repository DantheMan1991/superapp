...
--
-- Regenerating this file will undo the move. (First generated as 0354 on a
-- branch cut before slice 11b took that number; regenerated here as 0356 on
-- the rebased branch — same statements, same hand-move.)
