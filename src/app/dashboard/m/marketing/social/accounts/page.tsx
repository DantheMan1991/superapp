...
/**
 * The accounts a brand posts to (slice S0, ADR 0047).
 *
 * MOVED DOWN A LEVEL IN S1. `/social` is now the posts — the thing an owner
 * opens most days — and this is the rarer job of writing down where the
 * accounts are. Same screen, one segment deeper.
 *
            ...
            {brands.map((b) => {
              ...
              return (
                <li key={b.key}>
                  ...
                  <Link
                    href={`/dashboard/m/marketing/social/accounts?brand=${b.key}`}
