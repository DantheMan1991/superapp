  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // `max-h` plus `overflow-y-auto`: a dialog taller than the screen
          // SCROLLS. Without it a fixed, centred dialog overflows both edges
          // and nothing can reach the overflow — livestock's "Add animals"
          // form measured 885px tall in an 812px phone viewport, with its
          // title clipped off the top and its Start button off the bottom.
          // `dvh` follows the phone's dynamic viewport as the browser chrome
          // comes and goes; the 2rem matches the width rule beside it.
