...
/** The text slots of each kind, as path patterns; `[]` runs over an array. Nothing else is ever sent or changed. */
...
/** The section's words, keyed by path. Only strings that are there: a missing button has no label to rewrite. */
