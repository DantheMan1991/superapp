...
/* ------------------------------------------------------------------------
 * Saved-view query parsing. Pure, because the whole point of the design is
 * that a stored view is a bounded PARAMETER SET rather than SQL — which is
 * only true if the parser is total.
 * ---------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------
 * Tags and saved views against the database.
 * ---------------------------------------------------------------------- */
